  ...
  <div>
    ...
    <div style="padding:10px;">
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="TicketId" label="门票ID"></el-table-column>
        ...
        <el-table-column prop="UseDate" label="购票日期"></el-table-column>
        <el-table-column prop="Status" label="状态">
          <template slot-scope="scope">
            <el-tag :type="scope.row.Status?'success':'danger'">{{scope.row.Status?'已下单未付款':"付款成功"}}</el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="visiable" width="30%">
      <el-form :model="form" ref="form" label-width="80px" :rules="rulesObj">
        <el-form-item label="分类名" prop="CustomerId" id="file" type="file">
          <el-input placeholder="请输入分类名" v-model="form.TicketId"></el-input>
        </el-form-item>
        ...
        <el-form-item label="排序号">
          <el-input v-model="form.UseDate"></el-input>
        </el-form-item>
